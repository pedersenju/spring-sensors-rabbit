...
{
  "gitBranch" : "main",
  "gitUrl" : "https://github.com/pedersenju/spring-sensors-rabbit.git",
  "projectName" : "spring-sensors-rabbit",
  "publisherRepository" : "dev.registry.pivotal.io/se-americas-west",
...
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [https://github.com/tanzu-end-to-end/spring-sensors.git->https://github.com/p...(truncated), main->main]
...
┃ ┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [dev.local/spring-sensors-publisher->dev.registry.pivotal...(truncated)]
